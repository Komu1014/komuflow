...
const StatsPage=React.memo(function StatsPage({events,labels,onOpen}){
  ...
  return <div style={{flex:1,overflowY:"auto",padding:"14px 16px 100px"}}>
    ...
    <div style={{display:"flex",alignItems:"center",gap:8,marginBottom:12}}>
      ...
      {offset>0&&<button onClick={()=>setOffset(0)} style={{border:"1.5px solid #e5e7eb",background:"white",borderRadius:8,width:30,height:30,cursor:"pointer",fontSize:12,color:"#555",WebkitTextFillColor:"#555",flexShrink:0,textAlign:"center",display:"flex",alignItems:"center",justifyContent:"center"}}>今</button>}
